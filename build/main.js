...
_mongoose2.default.connect('mongodb://localhost/restaurant-mern');
...
var connect = exports.connect = function connect() {
  return _mongoose2.default.connect("mongodb://localhost:27017/restaurant-mern", { useNewUrlParser: true });
};
...
var _plats = __webpack_require__(22);

var _profil = __webpack_require__(26);
...
restRouter.use("/plats", _plats.platsRouter);
...
userRouter.post("/register", _user2.default.register);
...
var _jwt = __webpack_require__(7);
...
Object.defineProperty(exports, 'platsRouter', {
  enumerable: true,
  get: function get() {
    return _plats.platsRouter;
  }
});
...
var _plats2 = _interopRequireDefault(_plats);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var platsRouter = exports.platsRouter = _express2.default.Router();

platsRouter.post("/add", _plats2.default.create);
platsRouter.get("/", _plats2.default.findAll);
platsRouter.get("/:id", _plats2.default.findOne);
platsRouter.put("/:id", _plats2.default.update);
platsRouter.delete("/:id", _plats2.default.delete);
...
var _plats = __webpack_require__(25);
...
exports.default = {
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _ref = (req.body, _plats2.default), value = _ref.value, error = _ref.error;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              id = req.params.id;
              _context3.next = 4;
              return _plats2.default.findById(id);
            ...
            case 4:
              ...
              return _context3.abrupt('return', res.status(404).json({ err: 'could not find this dish' }));
  ...
  update: function update(req, res) {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
      var id, _req$body, value, error, plat;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              id = req.params.id;
              _req$body = req.body, value = _req$body.value, error = _req$body.error;
            ...
            case 5:
              _context4.next = 7;
              return _plats2.default.findOneAndUpdate({ _id: id }, req.body, { new: true });
            ...
            case 7:
              ...
              return _context4.abrupt('return', res.status(404).json({ err: 'could not find the dish' }));
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              id = req.params.id;
              _context5.next = 4;
              return _plats2.default.findOneAndRemove({ _id: id });
...
exports.default = _mongoose2.default.model("Plat", platSchema);
...
var _profil = __webpack_require__(27);
...
var _profil3 = __webpack_require__(30);
